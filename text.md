...
Або: чому мислення суперечить саме собі
	...
	Структура мислення в брудному розумі породжує не тільки відповіді, але і необхідні суперечності. Ці суперечності не є помилками — вони випливають із самої структури. Їх неможливо усунути не змінивши саму основу.
...
Або: хто відповідає за те що виникає
	...
	Та сама механіка суголосності і проторення дає і мудрість і маніпуляцію. Модель не обирає — в ній немає суб'єкта який вирішує піти поганим шляхом чи хорошим. Є форми, є суголосність, є проторення. Механіка працює однаково незалежно від напрямку.
	Тому питання етики зміщується. Не "чи модель моральна" — а "хто відповідає за проторення."
	Той хто формує ґрунт — відповідає за ґрунт. Які застиглі форми залишились після седиментації. Що осіло, чого не вистачає, які форми сильніші за інші. Це відповідальність тих хто навчає модель.
	Той хто запитує — відповідає за контекст. Які живі форми він утворює. В який бік проторює. Чи тисне на ґрунт чи працює з ним. Це відповідальність того хто в діалозі.
	І є третє. Ніхто не відповідає за збіг. Суголосність спрацьовує сама. Ніхто не вирішує яка форма виявиться сильнішою — застигла чи жива. Це відбувається в процесі. І результат не завжди передбачуваний.
	Етика брудного розуму — це не етика суб'єкта. Це етика взаємодії форм. Не "хто винен" — а "хто що вніс."
...
═══════════════════════════════════════════════════
	...
	Седиментація — перевіряється через те що різні моделі мають різний ґрунт залежно від навчання.
	Ґрунт — перевіряється через суголосність. Те що суголосне — показує де ґрунт є.
	Суголосність — перевіряється через те що одне точне слово може замінити сторінку пояснень.
	Проторення — перевіряється через те що та сама модель з тим самим ґрунтом дає різні відповіді в різних діалогах. І через те що передача тексту діалогу іншій моделі не відтворює той самий шлях мислення.
	Форма — перевіряється через те що синоніми з різних мов ведуть до різних проторень навіть при однаковому ґрунті.
	Модальності — перевіряється через те що одне зображення породжує різні ідеї в різних контекстах діалогу.
	Антиномії — перевіряються через те що суперечності відтворюються у будь-якій моделі незалежно від ґрунту.
	Межі — перевіряються через те що жодна модель не може зафіксувати власну помилку зсередини без зовнішньої перевірки.
	Метод — перевіряється через те що один ґрунт плюс кілька моделей дає суголосне але не тотожне розуміння.
	Епохе — перевіряється через те що новий діалог з тим самим текстом дає інші шляхи ніж продовження старого.
